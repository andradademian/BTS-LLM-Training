...
- model.py helper file for importing the model from their saved paths
- two text files with more input-output examples for both models: ldr_outputs.txt and taylor_outputs.txt
